...
6.Upload videos, results, and team reflections.`,
  ...
  "2": {
    ...
    description: {
      ...
      instructions: `1.Measure noise from different actions (dropping objects (pens, books) talking, walking, stamping your feet).
...
5.Repeat with a cardboard instead of a paper vertical.`,
  ...
  "4": {
    ...
    description: {
      ...
      instructions: `1.Build an anti-vibration layer, by folding paper/cardboard.
...
4.Modify the structure to reduce movement (e.g. more pillars, more folds, etc)`,
  ...
  "5": {
    ...
    description: {
      ...
      instructions: `1.Hold the phone firmly in one hand. Activate the App vibration sensor.
...
5.Upload results and reflect as a group.`,
  ...
  "6": {
    ...
    description: {
      ...
      instructions: `Phase 1 Tap Reaction
...
Rotate through each team member`,
  ...
  "7": {
    ...
    description: {
      ...
      instructions: `1.Place the phone gently on the chest.
